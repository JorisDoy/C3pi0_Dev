 ...
 */
public class Props {
    private String ejaze_low_balance, customer_number_format_invalid, customer_number_postpaid, customer_number_prepaid,
    ...
    private final String props_dir = "/opt/lnmp/topup.conf";
    //private final String props_dir ="C:\\opt\\lnmp\\topup.conf";
    ...
    public Props(){
        try{
            ...
            customer_number_prepaid = props.getProperty("customer_number_prepaid");
    ...
    public String getCustomer_number_prepaid() {
        return customer_number_prepaid;
    }
