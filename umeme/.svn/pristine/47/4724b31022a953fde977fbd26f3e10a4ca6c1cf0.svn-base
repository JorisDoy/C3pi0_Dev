...
<script type='text/javascript' src='<s:url value="/resources/assets/js/Chart.js"></s:url>'></script>
<script type='text/javascript' src='<s:url value="/resources/assets/js/graph-tools.js"></s:url>'></script>

 <div class="row-fluid">
     <div class="span12 post-page">
         
         <h3 class="module-title-short">
             <span class="selected"><s:message code="page.title.mycontract.billinggraphical" /></span>
         </h3>
                 ...
                 <form>
                     <div class="row-fluid">                     
	                         ...
	                         <div class="formGroup">
	                             <div class="formGroup">
	                                 <label for="contractNumber">
				                        <s:message code="billing.graphical.combo.contract" />
				                     <label>
				                     <select path="contractNumber" cssClass="form-control"
				                          cssErrorClass="form-control has-errors"
				                          id="contractNumber" required="true" placeholder="contract number..." style="width:100%;">
				                    <select>
	                             </div>
	                         </div>
                         </div>
                         <div class="span4">
                             <div class="formGroup">
	                             <label for="year">
			                         <s:message code="billing.graphical.combo.year" />
			                     <label>
			                     <select path="year" cssClass="form-control"
			                          cssErrorClass="form-control has-errors"
			                          id="year" required="true" placeholder="year">
			                    <select>
	                         </div>
                         </div>
                         <div class="span2">
	...
	<ul class="nav nav-pills">
		<li role="presentation"><a id = "bill-list" href="<c:url value="/"/>"><s:message code="bill.billList.nav_button.text" /></a></li>
		<li role="presentation"  class="active"><a href="#"><s:message code="bill.billGraph.nav_button.text" /></a></li>
	</ul>
</div>
                     <div class="row-fluid"> 
                     <div class="span12">
  ...
  <script>
	 ...
	 $(document).ready(function() {
		 ...
		 $('#bill-list').click(function() {			 
			 ...
			 var s = 'client/contract/specific/bills?contractNumber=' + $('#contractNumber option:selected').text().split(" ")[0] + '&year=' + $('#year option:selected').text().split(" ")[0];
