...
<xsl:stylesheet version="1.0"
 ...
 <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
     ...
     <fo:simple-page-master master-name="simple"
	   ...
	   <fo:region-body margin-bottom="0in" margin-left="0in" margin-right="0in" margin-top="0in"/> <!--  background-image ="file:///f:/temp/image1.gif" background-repeat="no-repeat" background-position="center" -->
...
<!--ROW 5-->
<fo:table-row height="10px" border-style="solid">
<fo:table-cell >
<fo:block></fo:block>
</fo:table-cell>
<fo:table-cell number-columns-spanned="2">
...
<fo:table table-layout="fixed" width="100%" border-style="hidden">
<fo:table-column column-width="140px" border-style="hidden"/>
<fo:table-column column-width="110px" border-style="hidden"/>
<fo:table-column column-width="90px" border-style="hidden"/>
<fo:table-column column-width="90px" border-style="hidden"/>
<fo:table-column column-width="95px" border-style="hidden"/>
<fo:table-body>
<!--CREDITS-->
<fo:table-row height="9px" border-style="hidden">
<fo:table-cell  display-align="center">
...
<xsl:template match="Statement/Page/statementInvoices/Invoice/invoiceItems">
 <xsl:param name="total-items" select ="count(./Item) "/>
   ...
   <xsl:sort select="@ItemSequenceNumber"/>
	...
	<xsl:if test="./itemCode/@itemCodeCode != 'CC110'" >
	  ...
	  <fo:table-row height="12px" border-style="hidden">
		...
		<!--START MOE 24/04/14 Resolve duplicate itemBilledUsage-->
  ...
  <xsl:call-template name="dots">
      <xsl:with-param name="count" select="19 - $total-items"/>
    </xsl:call-template>
