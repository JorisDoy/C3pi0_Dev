		...
		<div class="row-fluid">
			<div class="span12 post-page">
				<ul class="nav nav-tabs">
					...
					<li class="active"><a href="<c:url value="/employee/connection/pendingconnection?schedule=true"/>"><s:message code="connection.scheduleexpecting.tab" /></a></li>
				...
				<h3 class="module-title-short">
					<span class="selected"><s:message
							code="connection.scheduleexpecting.tab" /></span>
				</h3>
					...
					<div class="panel-body">
						...
						Phone Number, Duration in status “Inspection Paid” -->
							<table class="table table-condensed table-hover">
								<thead>
									<tr>
										<th><s:message code="connection.col.connectionScheduledDate" /></th>
								...
								<tbody>
									<c:forEach items="${scheduledApplications}" var="application">
										<tr class="active">
											<td>${application.connectionScheduledDate}</td>
											...
											<%-- <td><a
												href="<c:url value="/employee/connection/connectionresults/"/>${application.codApplication}"><s:message
														code="scheduled.inspection.view" /></a></td> --%>
														<td><a
												href="<c:url value="/employee/connection/connectionresults/"/>${application.codApplication}"><s:message
														code="scheduled.connection.resultslink" /></a></td> 
										</tr>
									</c:forEach>
								</tbody>
							</table>
