...
<%@ taglib uri="http://tiles.apache.org/tags-tiles" prefix="t" %>
 ...
 <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	...
	<link rel="stylesheet" href='<s:url value="/resources/assets/css/aside-left-menu.css"></s:url>'>
	<%-- <link rel="stylesheet" href='<s:url value="/resources/assets/css/bootstrap.css"></s:url>'> --%>
     <link  href='<s:url value="/resources/assets/css/bootstrap.css"></s:url>' rel="stylesheet" id="bootstrap-css">
	...
	<!-- JS -->
	<script type='text/javascript' src='<s:url value="/resources/assets/js/jquery-1.11.2.js"></s:url>'></script>
	...
	<script type='text/javascript' src='<s:url value="/resources/assets/js/bootstrap.min.js"></s:url>'></script>
