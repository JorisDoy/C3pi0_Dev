...
<c:set var="customerExist" value="${customerExist}" />
	...
	<div class="container">
		<div class="row-fluid">
			<div class="span12 post-page">
				...
				<div class="row-fluid" id="btnEdit">
					<div class="span3">&nbsp;</div>
					<div class="span3">&nbsp;</div>					
					<div class="span3">
						<button id="editProfileBtn" class="btn btn-lg btn-primary btn-block" type="submit">
							<s:message code="editprofile.value" />
						</button>
					</div>
				</div>
				...
				<form:form method="POST" commandName="profile" cssClass=" register"
					...
					<fieldset>
						<legend>
							<s:message code="myprofile.fieldset.personaldetails" />
						</legend>
						<div class="row-fluid">
							<div class="span3">
								<div class="formGroup formGroupEdit">
									...
									<form:input path="surname" cssClass="form-control"
										...
										id="surname" type="text" required="required"
										placeholder="surname..." />
									<form:errors path="surname" cssClass="has-errors"
										element="span" />
							...
							<div class="span3">
								<div class="formGroup formGroupEdit">
									...
									<form:input path="middleName" cssClass="form-control"
										readonly="true" cssErrorClass="form-control has-errors"
										id="middleName" type="text" required="required"
							...
							<div class="span3">
								<div class="formGroup">
									...
									<form:input path="idNumber" cssClass="form-control"
										readonly="true" cssErrorClass="form-control has-errors"
										id="idNumber" type="text" required="required"
							...
							<div class="span3">
								<div class="formGroup formGroupEdit">
									...
									<form:input path="emailAddress" cssClass="form-control"
										readonly="true" cssErrorClass="form-control has-errors"
										id="emailAddress" type="text" required="required"
										placeholder="email..." />
							...
							<div class="span3">
								<div class="formGroup formGroupEdit">
									...
									<form:input path="officeNumber" cssClass="form-control"
										readonly="true" cssErrorClass="form-control has-errors"
										id="officeNumber" type="text" required="required"
					...
					<fieldset>
						<legend>
							<s:message code="myprofile.fieldset.contactpersondetails" />
						</legend>
						<div class="row-fluid">
							<div class="span3">
								<div class="formGroup formGroupEdit">
									<form:label path="contactPerson.name"
									...
									<form:input path="contactPerson.name" cssClass="form-control"
										...
										id="contactpersonname" required="required" readonly="true"
							...
							<div class="span3">
								<div class="formGroup formGroupEdit">
									...
									<form:input path="contactPerson.phoneNumber" readonly="true"
						...
						<div class="row-fluid">
							...
							<div class="span3">
								<div class="formGroup">
									...
									<form:input path="premiseInformation.landmark" readonly="true"
										cssClass="form-control"
										cssErrorClass="form-control has-errors" id="landmark"
										type="text" required="required" placeholder="landmark ..." />
					...
					<div class="row-fluid" id="btnSubmit" style="display: none;">
						<div class="span3">&nbsp;</div>
						<div class="span3">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		function setEditMode() {
			$("#btnSubmit").show();
			$("#btnEdit").hide();
			$(".formGroupEdit :input").removeAttr('readonly');
			$(".formGroupEdit select").removeAttr('disabled');
		}
